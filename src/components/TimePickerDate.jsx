...
import { alterDateHours,getSelectedDates } from '../service/storaje';
  ...
  handleHourChange = e => {
    if(!isNaN(e.target.value)){
      ...
      if(e.target.id === 'startHour'){
        if (newHour >= 0 && newHour < this.state.endHour && newHour < 24){
          this.changeTime(newHour, e.target.id)
        }
      }else {
        if (newHour > 0 && newHour > this.state.startHour && newHour < 25){
          this.changeTime(newHour, e.target.id)
        }
      }
    }
      ...
      <div className="grid__contrat">
        <div>
          ...
          <div className="input-group inline-group">
            ...
            <input className="form-control quantity" min="0" name="quantity" value={startHour} type="number" name="startHour" id="startHour" onChange={handleHourChange}/>
        ...
        <div>
          ...
          <div className="input-group inline-group">
            ...
            <input className="form-control quantity" min="0" name="quantity" value={endHour} type="number" name="endHour" id="endHour" onChange={handleHourChange}/>
            <div className="input-group-append">
